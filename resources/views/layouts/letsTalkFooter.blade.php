<section class="section-cta py-5 bg-primary text-white">
    <div class="container">
        <div class="text-center">
            <img class="profile-small d-inline-block mx-auto rounded-circle mb-2" src="assets/images/sunwhite.jpeg" alt="">
        </div>
        ...
        <div class="section-intro mx-auto text-center mb-3">
            ...
            <a class="link-on-bg text-link" href="mailto:sundaywht@gmail.com">sundaywht@gmail.com</a> or use the 
            <a class="link-on-bg text-link" href="contact">form on the contact page</a>.
        </div>
        <div class="text-center">
